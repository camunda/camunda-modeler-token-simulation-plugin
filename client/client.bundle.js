...
/* harmony export */   "default": () => (/* binding */ BreakpointsMode)
/* harmony export */ });
...
function BreakpointsMode(eventBus,overlays,simulator) {
    const self = this;
    ...
    this.newOverlayBadgeForDocOrder = (element)  => {
        const overlayHtml = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)(`<div class="breakpoints-order breakpoints-order-show order-count" title="BreakPoints Order"></div>`);
...
/* harmony import */ var _BreakpointsMode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./BreakpointsMode */ "./client/BreakpointsMode.js");
...
const TokenSimulationPluginModule = {
  ...
  breakpointsMode: ['type', _BreakpointsMode__WEBPACK_IMPORTED_MODULE_2__.default ]
};
